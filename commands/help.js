...
let prefix = ("*")
  ...
  module.exports.run = async (bot, message, args) => {
    ...
    let hembed = new Discord.RichEmbed()
       ...
       .setColor("#000000")
       .addField("Hello!", "Hello " + message.author.username +  " These are the commands available.\n")
       ...
       .addField("Command 4:", `***${prefix}ban <@user#id reason>*** \nThis command will ban the mentioned user and send the ban report to the incidents channel.`)
       .addField("Command 5:", `***${prefix}report <@user#id reason>*** \nThis command report the mentioned user and send it to the incidents channel.`)
       .addField("Command 6:", `***${prefix}serverinfo*** \nThis command will display the server info.`)
       .addField("Command 7:", `***${prefix}botinfo*** \nThis command will give you the bot information.`)
       .addField("Command 8:", `***${prefix}ping*** \nThis command will show you your ping.`)
       .addField("Command 9:", `***${prefix}servers*** \nThis will DM you a list of my recommended servers.`)
       .addField("Command 10:", `***${prefix}coins*** \nThis command lets you see your coins.`)
       .addField("Command 11:", `***${prefix}level*** \nThis command will let you see your level, how much xp you have and how much until the next level.`)
       ...
       .addField("Command 18:", `***${prefix}setprefix <desired prefix>*** \nThis command will set the bot prefix to any prefix that you want. *Only 1 character is reccomended!* (Command still in development.)`)
